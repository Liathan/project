...
state_action(search_false, move, 0).
state_action(search_false, lookAround, 0).

state_action(search_true, move, 0).
state_action(search_true, lookAround, 0).

state_action(runn_false, move, 0).
state_action(runn_false, lookAround, 0).

state_action(runn_true, move, 0).
state_action(runn_true, lookAround, 0).
