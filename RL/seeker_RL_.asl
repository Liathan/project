//Lo stato è rappresentato da la "modalità" in cui è e se l'ultima azione effettuata è la lookAround

state_action(search, false, move, 0).
state_action(search, false, lookAround, 0).

state_action(search, true, move, 0).
state_action(search, true, lookAround, 0).

state_action(runn, false, move, 0).
state_action(runn, false, lookAround, 0).

state_action(runn, true, move, 0).
state_action(runn, true, lookAround, 0).
